...
public class InfectedSelectAdapter extends RecyclerView.Adapter<InfectedSelectAdapter.ViewHolder> {
    ...
    public InfectedSelectAdapter(ArrayList<Infected> items, Context context, AdapterListener adapterListener) {
